...
filenames=os.listdir("data/07212019")
#%%
dir_name="data/07212019sorted"
os.mkdir(dir_name)
# importing data from a file function
def cleancsv(filename):
    dir_name="data/07212019"
...
timeslots=np.arange(0,timenum).transpose()
    #%%
filenames=os.listdir("data/07212019sorted")
#%%
# importing data from a file function
...
timenum=3600*samplingrate
timeslots=np.arange(0,timenum).transpose()
dir_name="data/07212019mat"
os.mkdir(dir_name)
dir_name="data/07212019pkl"
os.mkdir(dir_name)
...
for file in filenames:
    ...
    data['hour']=np.ones(timenum)*(int(file.split(sep='.')[0]))
