...
# =============================================================================
# =============================================================================
# # test the new data based on previous thresholds
# =============================================================================
# =============================================================================
start,SampleNum,N,filename=(0,40,500000,'data/Armin_Data/July_03/pkl/jul3.pkl')
X_train= load_data(start,SampleNum,N,filename)
#batch_count = X_train.shape[0] / batch_size
...
for anom in anoms_1225:
    ...
    plt.legend('A' 'B' 'C')
    plt.title('Q')    
#    plt.savefig('figures/testGANStatistic/anom %d.png' %anom)
    plt.show()
#    print(a[int(anom)])
    #%%
event_points=[]
...
pointers = loadmat('data/Armin_Data/pointer.mat')
day=3
day_name='Jul_0'+str(day)
points=pointers['pointer'][day_name][0][0].ravel()