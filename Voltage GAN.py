...
#    generator.add(LeakyReLU(0.2))
    ...
    generator.add(Dense(units=3*40))
...
def create_discriminator():
    ...
    discriminator.add(CuDNNLSTM(units=256,input_shape=(40,3),return_sequences=True))
...
def create_gan(discriminator, generator):
    ...
    x = Reshape((40,3), input_shape=(3*40,1))(x)
...
def training(generator,discriminator,gan,epochs, batch_size):
    ...
    for e in range(1,epochs+1 ):
        ...
        #generate  random noise as an input  to  initialize the  generator
            ...
            generated_images = generated_images.reshape(batch_size,SampleNum,3)
...
#%%
##
#gan.save('GPU_gan_voltage_N500000_e100_b10_1225.h5')
#generator.save('GPU_generator_voltage_N500000_e100_b10_1225.h5')
#discriminator.save('GPU_discriminator_voltage_N500000_e1000_b10_1225.h5')
#%%

gan=load_model('GPU_gan_voltage_N500000_e100_b10_1225.h5')
generator=load_model('GPU_generator_voltage_N500000_e100_b10_1225.h5')
discriminator=load_model('GPU_discriminator_voltage_N500000_e1000_b10_1225.h5')
#%%
filename='data/Armin_Data/July_03/pkl/J3.pkl'
...
#    os.mkdir(dst)
    ...
    # =============================================================================
    anomcsvfile=dst+"/anoms_voltage_"+file+".csv"
    ...
    dst="figures/all_events/"+file
    anomcsvfile=dst+"/common_voltage"+file+".csv"
