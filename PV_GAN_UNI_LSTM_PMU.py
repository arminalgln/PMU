...
#    selected_data=0
    ...
    train_data=np.zeros((N,f_num,SampleNum))
...
def create_discriminator():
    ...
    discriminator.add(CuDNNLSTM(units=256,input_shape=(40,1)))
...
def create_gan(discriminator, generator):
    ...
    x = Reshape((40,1), input_shape=(40,1))(x)
...
X_train=X_train.reshape(N,SampleNum,1)
#%%
